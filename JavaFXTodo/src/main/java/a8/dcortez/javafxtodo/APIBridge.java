...
public class APIBridge {
    ...
    private static final String baseURL = "https://javafxtodo-acdd7-default-rtdb.firebaseio.com/";
    private static final String apiKey = "aJeeitywv1d4wq2obyRfwIlc3mrrCuFGApazUrd6";
